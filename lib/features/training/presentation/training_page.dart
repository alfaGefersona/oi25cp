          ...
          return Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(t["title"] as String, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                    ...
                    children: List.generate(
                      4,
                        ...
                        decoration: BoxDecoration(
                          color: i2 < (t["level"] as int) ? Colors.white : Colors.transparent,
